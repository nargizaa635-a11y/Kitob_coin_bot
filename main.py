...
async def cmd_admin(message: Message):
    ...
    await message.answer(
        ...
        f"🛍 Do'kon narxini tahrirlash:\n"
        f"<code>/tahrirla_dokon</code> — ro'yxat va ko'rsatma\n\n"
        f"📦 Sandiqlar:\n"
        f"<code>/sandiqlar</code> — ro'yxat, <code>/sandiq_qosh</code> — yangi qo'shish\n\n"
...
async def api_book_page_data(request: web.Request):
    ...
    return web.json_response({
        "type": "image",
        "image_url": f"/api/page_image/{book_id}/{page_number}?initData={init_data}",
    })
